...
// authResponse is the success payload for Register / Login. Centralized
// so the wire shape doesn't drift between the two endpoints.
...
func (h *AuthHandler) Register(c *gin.Context) {
	...
	httpx.OK(c, authResponse{User: u, AccessToken: token, TokenType: "Bearer"})
}
